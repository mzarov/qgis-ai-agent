...
from ai_agent.qgis_tools.osm.extent import canvas_bbox, parse_bbox
from ai_agent.qgis_tools.osm.load import SUBLAYERS
from ai_agent.qgis_tools.osm.selectors import SHAPE_HINT, normalize
