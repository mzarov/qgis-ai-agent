...
LABELS = PropertySet(
    ...
    [
        StyleProperty(
            "field",
            KIND_TEXT,
            "Поле, значениями которого подписывать объекты",
            TARGET_SETTINGS,
            setter("fieldName"),
        ),
        ...
        StyleProperty(
            "font",
            KIND_TEXT,
            "Семейство шрифта, например Arial или Times New Roman",
            TARGET_FONT,
            method("setFamily"),
        ),
        ...
        StyleProperty(
            "opacity",
            KIND_NUMBER,
            "Прозрачность подписи: 1 — непрозрачная",
            TARGET_FORMAT,
            method("setOpacity"),
            minimum=0.0,
            maximum=1.0,
        ...
        StyleProperty(
            "buffer",
            KIND_BOOLEAN,
            "Обводка вокруг текста (ореол): false — убрать",
            TARGET_BUFFER,
            ignored(),
        ),
        StyleProperty(
            "buffer_color",
            KIND_COLOR,
            "Цвет обводки текста, обычно white",
            TARGET_BUFFER,
            method("setColor"),
        ),
        StyleProperty(
        ...
        StyleProperty(
            "offset_x",
            KIND_NUMBER,
            "Сдвиг подписи вправо от точки привязки",
            TARGET_SETTINGS,
            setter("xOffset"),
            minimum=-100.0,
            maximum=100.0,
        ...
        StyleProperty(
            "offset_y",
            KIND_NUMBER,
            "Сдвиг подписи вниз от точки привязки; вверх — отрицательное число",
            TARGET_SETTINGS,
            setter("yOffset"),
            minimum=-100.0,
            maximum=100.0,
        ...
        StyleProperty(
            "distance",
            KIND_NUMBER,
            "Отступ подписи от самой геометрии",
            TARGET_SETTINGS,
            setter("dist"),
            minimum=0.0,
            maximum=100.0,
        ...
        StyleProperty(
            "background",
            KIND_BOOLEAN,
            "Подложка под подписью: false — убрать",
            TARGET_BACKGROUND,
            ignored(),
        ),
        StyleProperty(
